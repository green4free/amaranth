...
class FragmentTransformer:
    def map_subfragments(self, fragment, new_fragment):
        #new_fragment.subfragments.extend((self(subfragment), name, src_loc) for subfragment, name, src_loc in fragment.subfragments)
        # This was a small optimization for run-time, but it's probably not needed 
    ...
    def on_fragment(self, fragment):
        ...
        new_fragment._p_signature = fragment._p_signature
