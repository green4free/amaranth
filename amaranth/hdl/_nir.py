...
class Netlist:
    ...
    def add_module(self, parent, name: str, *, src_loc=None, cell_src_loc=None, p_signature=None):
        module_idx = len(self.modules)
        self.modules.append(Module(parent, name, src_loc=src_loc, cell_src_loc=cell_src_loc, p_signature=p_signature))
        if module_idx == 0:
...
class Module:
    ...
    """
    def __init__(self, parent, name, *, src_loc, cell_src_loc, p_signature=None):
        self.parent = parent
        self.name = name
